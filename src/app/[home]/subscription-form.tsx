...
export default function SubscriptionForm() {
  ...
  return (
    <form
     ...
     className="bg-gray-700 border border-gray-600 rounded-2xl px-8 space-y-6 w-full md:max-w-[440px]">
